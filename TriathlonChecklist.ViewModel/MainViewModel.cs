// <copyright file="MainViewModel.cs" company="cematinlà.com">
...
namespace TriathlonChecklist.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        /// Get data method
        /// </summary>
        /// <param name="reinitializeUI">Reinitialize or not the UI</param>
        public void GetDataAndReinitializeUI(bool reinitializeUI)
        {
